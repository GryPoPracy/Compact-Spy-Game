...
/// Experimental class.
/// </summary>
[Serializable] public class EffectConstructor
{
    ...
    [Serializable] public class ConstructorParameter
    {
        ...
        public Color ColorValue = new Color();
    ...
    public EffectConstructor() {}

    public EffectConstructor(ConstructorInfo info)
    {
    ...
    public IEffect CreateInstance()
    {
        ...
        return Activator.CreateInstance(_type, data) as IEffect;
    }
    ...
    public static bool operator !=(EffectConstructor a, EffectConstructor b)
    {
        return !(a == b);
    }
